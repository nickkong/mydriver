package com.zhtaxi.haodidriver.util;
...
public class UpdateManager {
    ...
    private static final String saveFileName = savePath + "/haodidriver.apk";
...
//                Log.d(TAG, responseString);
        ...
        client.get(mContext, "http://api.fir.im/apps/latest/579974c2548b7a39b600099e?api_token=9677acf457fea2e6a143c849c62cd09f", null, asyncHttpResponseHandler);
